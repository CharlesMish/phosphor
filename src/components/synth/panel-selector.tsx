...
function PanelDiagram({ panel }: { panel: Panel }) {
  ...
  return (
    <svg viewBox="0 0 52 38" width="52" height="38" fill="none" aria-hidden>
      ...
      <rect x="4" y="5" width={width} height={panel === "desk" ? 15 : 21} rx={panel === "cabinet" ? 0 : 1.5} stroke="currentColor" opacity=".7" />
      <path d={panel === "desk" ? "M6 13 Q12 4 19 13 T32 13 T45 13" : "M6 16 Q12 3 19 16 T33 16"} stroke="currentColor" strokeWidth="1.2" />
      {panel === "desk" ? (
        <path d="M4 24 H48 M18 22 V26 M34 22 V26" stroke="currentColor" opacity=".45" />
      ) : (
        <path d="M40 8 H47 M40 15 H47 M40 22 H47" stroke="currentColor" opacity=".55" />
      )}
